...
const navItems: NavItem[] = [
  ...
  { label: '代理人確認', to: '/leave/proxy-review', icon: <CalendarOff className="h-5 w-5" />, roles: ['employee', 'manager'] },
  { label: '年度假期月曆', to: '/holidays', icon: <CalendarOff className="h-5 w-5" />, roles: ['employee', 'manager'] },
